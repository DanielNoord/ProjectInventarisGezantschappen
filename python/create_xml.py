...
def volume_entry(number, title, date, parent_element, localization):
    ...
    c01_id = etree.SubElement(c01, "did")
    c01_did_id = etree.SubElement(c01_id, 'unitid', type = "series_code")
    c01_did_id.text = number + "."
    c01_did_id = etree.SubElement(c01_id, 'unittitle')
    c01_did_id.text = title
    date1, date2 = helper_functions.extract_date(date, localization)
    c01_did_date = etree.SubElement(c01_id, 'unitdate', calendar = "gregorian",\
        era = "ce", normal = date)
...
def dossier_entry(v_number, number, pages, title, date, parent_element, localization):
    ...
    c02_id = etree.SubElement(c02, "did")
    c02_did_id = etree.SubElement(c02_id, 'unitid', type = "series_code")
    c02_did_id.text = f"{v_number}.{number}"
    c02_did_id = etree.SubElement(c02_id, 'unittitle')
    c02_did_id.text = title
    date1, date2 = helper_functions.extract_date(date, localization)
    c02_did_date = etree.SubElement(c02_id, 'unitdate', calendar = "gregorian",\
        era = "ce", normal = date)
...
def dossier_with_desc(pages, title, place, date, parent_element, localization):
    ...
    c03_did_id.text = title
    date1, date2 = helper_functions.extract_date(date, localization)
    c03_did_date = etree.SubElement(c03_id, 'unitdate', calendar = "gregorian",\
        era = "ce", normal = date)
...
def dossier_specific_file(pages, title, place, date, parent_element, localization):
    ...
    c04_id = etree.SubElement(c04, "did")
    c04_did_id = etree.SubElement(c04_id, 'unitid', type = "series_code")
    c04_did_id.text = f"pp. {pages}"
    c04_did_id = etree.SubElement(c04_id, 'unittitle')
    c04_did_id.text = title
    date1, date2 = helper_functions.extract_date(date, localization)
    c04_did_date = etree.SubElement(c04_id, 'unitdate', calendar = "gregorian",\
        era = "ce", normal = date)
